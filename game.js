...

...
function getTileSpriteCoords(tileType, isTopmost, r, c, tileAnimFrame) {
  const spriteSize = 64;
  let row, col;
  switch (tileType) {
    case Tile.Dirt:
    ...
    for (let c=0; c<cols; c++){
      ...
      if (tileType !== Tile.Void) {
        ...
        if (tilesSpriteSheet.complete) {
          ...
          const isTop = !(tileAboveProps && hasBehavior(tileAboveProps.behaviors, props.behaviors));
